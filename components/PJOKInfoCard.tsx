    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed right-4 bottom-28 md:bottom-24 z-40 bg-white/5 backdrop-blur-md hover:bg-white/10 border border-white/10 rounded-full p-2 transition-all duration-fast ease-smooth active:scale-95 shadow-lg"
      ...
      {isOpen && (
        <div className="fixed right-4 bottom-[calc(7rem+0.5rem)] md:bottom-[calc(6rem+0.5rem)] z-40 w-72 bg-[#0f172a]/95 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-2xl animate-modal-enter origin-bottom">
